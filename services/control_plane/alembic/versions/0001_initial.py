...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("owner_type", sa.Enum("user", "application", name="apikeyownertype", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("transport", sa.Enum("streamable_http", name="transporttype", create_type=False), nullable=False, server_default="streamable_http"),
        sa.Column("status", sa.Enum("active", "disabled", name="servicestatus", create_type=False), nullable=False, server_default="active"),
        sa.Column("health_status", sa.Enum("healthy", "unhealthy", "unknown", name="healthstatus", create_type=False), nullable=False, server_default="unknown"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("success", "error", "timeout", name="callstatus", create_type=False), nullable=False),
